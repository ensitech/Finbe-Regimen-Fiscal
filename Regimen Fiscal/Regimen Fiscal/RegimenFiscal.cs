...
using Regimen_Fiscal.AxService;
using System;
...
namespace Regimen_Fiscal
{
    public class RegimenFiscal : IPlugin
    {
        ...
        private void SendRegimenFiscal(IOrganizationService service, Entity entity, Entity configuration, string domainUserName)
        {
            ...
            var result = axServiceProd.createOrUpdateRegimenFiscal(xml, connection.Item1);
            ...
            axServiceProd.Url = connection.Item2.ToString();
            result = axServiceProd.createOrUpdateRegimenFiscal(xml, connection.Item1);
